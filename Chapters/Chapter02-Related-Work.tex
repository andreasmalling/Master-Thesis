...
\emph{Scalability} is how the system's performance should increase as number of peers grows, which also state that network performance can be measured by average file downloading time.
