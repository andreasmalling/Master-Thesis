...
\lstinputlisting[
    language=MPD,
    caption={
        [\ac{MPD} snippet with location addresses]
...
\lstinputlisting[
    language=MPD,
    caption={
        [\ac{MPD} snippet with content addresses]
...
\begin{figure}
    ...
    \caption{Comparison of the overhead present in virtualization done by \acp{VM} and by Docker}
...
\begin{itemize}
    ...
    \item \ac{CSV} files with every plot it generates.
\end{itemize}
