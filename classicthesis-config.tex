...
% ****************************************************************************************************
\newcommand{\myTitle}{Creating the ultimate video streaming service\xspace}
\newcommand{\mySubtitle}{Using the outstanding potential of the interplanetary file system technology\xspace}
\newcommand{\myDegree}{Master's Thesis\xspace}
\newcommand{\myName}{Andreas Østergaard\xspace}
\newcommand{\myStudentId}{201303***\xspace}
