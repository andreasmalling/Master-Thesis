...
% ****************************************************************************************************
\newcommand{\myTitle}{Utilizing IPFS as a content provider for DASH video streaming\xspace}
\newcommand{\mySubtitle}{Evaluating the user experience and performance of DASH streaming with decentralized video content delivered through IPFS\xspace}
...
% Exp. ID
\usepackage{suffix}
\newcommand{\expidprefix}{Exp.ID\xspace}                    %Prefix
\newcommand{\setexpid}[1] {\label{exp:#1}#1}                %Set ID
\newcommand\expid[1] {\hyperref[exp:#1]{\expidprefix #1}}   %Hyperref ID
\WithSuffix\newcommand\expid*[1] {\expidprefix #1}          %Nameref ID
...
\lstdefinelanguage{env}{
  ...
  keywords=[2]{image, environment, ports, container_name, ports, links, build, depends_on, command, volumes,privileged,restart},
...
\newcommand{\source}[1]{\vspace{-8pt}\captionsetup{font={footnotesize,it}}\caption*{\textit{Source: {#1}}} }
...
\hypersetup{%
    ...
    pdftitle={\myTitle},%
    pdfauthor={\textcopyright\ \myName \& \myOtherName, \myUni, \myFaculty},%
    pdfsubject={},%
    pdfkeywords={IPFS, Interplanetary File system, DASH, Dynamic Adaptive Streaming over HTTP, Docker, Streaming, Chaos Engineering},%
    pdfcreator={pdfLaTeX},%
