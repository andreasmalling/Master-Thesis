\begin{figure}[ht]
    ...
    \end{tikzpicture}
    \caption[Total bandwidth from \expid{B10-g}]{Total bandwidth for each user from \expid{B10-g} users do not tend to download more than around 250 \acs{MB} unlike the baseline where some users could end up downloading much more.}
