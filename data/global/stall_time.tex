\begin{figure}[ht]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption[Stalls over time from \expid{B10-g}]{Stalls over time from \expid{B10-g} showing that although there were not many stalls, the few that were there lasted several sseconds.}
