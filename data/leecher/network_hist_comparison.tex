...
%        x tick label style={rotate=60, anchor=east},
    ...
    \end{tikzpicture}
    \caption[Mean bandwidth per client from Leecher exps.]{Mean bandwidth for each type of client for  (1) a network with 5 Binge, (2) a network with 5 Leecher and 5 Binge.}
