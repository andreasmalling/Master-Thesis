\begin{figure}[ht]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption[Stalls over time from \expid*{L1B9}]{Stalls over time from the 1 Leecher and 9 Bingers experiment (\expid{L1B9}).\\ The Leecher stalls multiple times during the experiment and not only at the beginning like the Bingers.}
