\begin{figure}[ht]
    ...
    \end{tikzpicture}
    \caption[Total stall time from 1 Leecher exp.]{Total stall time per client, from the 1 Leecher experiment. Only the leecher stalls for a long time, while binge users barely stall at all.}
