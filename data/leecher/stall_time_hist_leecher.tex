\begin{figure}[ht]
    ...
    \end{tikzpicture}
    \caption[Total stall time from \expid*{L1B9}]{Accumulated stall time per client, from the 1 Leecher and 9 Bingers experiment (\expid{L1B9}).\\Only the Leecher stalls for a long time, while Bingers barely stall at all.}
