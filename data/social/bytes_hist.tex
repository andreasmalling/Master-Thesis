\begin{figure}[ht]
    ...
    \end{tikzpicture}
    \caption[Mean received \ac{MB} from socialness experiments]{Mean of accumulated received data from \expid{B10-s1}, \expid{B10}, \expid{B10-s2}. Decreasing socialness gives reduces the amount of duplicate data the users receive.}
