\begin{figure}[ht]
    ...
    \end{tikzpicture}
    \caption[Mean bandwidth of Binge from \expid*{B5} and \expid*{I5B5}]{Mean of the accumulated data received and transmitted for 5 Bingers with and without 5 Incognito users in the network (\expid{I5B5} and \expid{B5}). \newline 
