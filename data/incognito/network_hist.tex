\begin{figure}[ht]
    ...
    \end{axis}
    \end{tikzpicture}
    \caption[Bandwidth per client, from 10 Incognito exp.]{Recieved and transmitted data or each client, from the 10 Incognito users experiment. Like the baseline the first users download significantly less, and most download less than the video size.}
