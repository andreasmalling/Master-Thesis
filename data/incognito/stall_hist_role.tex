\begin{figure}[ht]
    ...
    \begin{axis}[
        ...
        ylabel={Mean accumulated stall time (\acs{ms})},
    ...
    \end{tikzpicture}
    \caption[Mean stall time from \expid*{I5B5}]{Mean of accumulated stall time for Binger clients compared to Incognito clients, from the 5 Incognito experiment (\expid{I5B5}). \newline Incognito users stall much longer before they start playing the video.}
