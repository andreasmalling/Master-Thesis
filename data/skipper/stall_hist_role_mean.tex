...
%        x tick label style={rotate=60, anchor=east},
    ...
    \end{tikzpicture}
    \caption[Mean stall time for Skipper exps.]{Mean stall time for Skippers, (1) is a network with 5 Skipper and 5 Binge, (2) is a network with 10 Skipper. Stall time is almost identical regardless of the amount of skippers.}
