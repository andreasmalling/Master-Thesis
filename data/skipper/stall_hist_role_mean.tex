...
%        x tick label style={rotate=60, anchor=east},
    ...
    \end{tikzpicture}
    \caption[Mean stall time for Skipper exps.]{Mean stall time for Skippers.\newline 
    (1) is a network with 5 Skipper and 5 Binge (\expid{S5B5}),\newline
    (2) is a network with 10 Skipper (\expid{S10}).\newline
