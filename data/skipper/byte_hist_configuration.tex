\begin{figure}[ht]
    ...
    \end{tikzpicture}
    \caption[Total bandwidth from \expid{S5cB5}]{Received and transmitted data per client, from the 5 Skipper experiment with the configuration 1 second watch time and 25 seconds skips (\expid{S5cB5}).\newline
