\begin{figure}[htbp]
    ...
    \end{tikzpicture}
    \caption[Mean received data from \expid*{B10-v9}]{Mean of accumulated received data with std. dev. from the baseline experiment with 3 \acs{s} segments (\expid{B10}) and the segment experiment with 9 \acs{s} (\expid{B10-v9}).\\
