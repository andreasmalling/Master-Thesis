\begin{figure}[ht]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption[Stalls over time from \expid{B10-m2}]{Stalls over time from \expid{B10-m2} showing that even though there was a small amount of stalls, those that were there lasted several seconds.}
